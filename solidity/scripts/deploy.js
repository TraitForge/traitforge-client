...
async function main() {
  ...
  const customERC721 = await CustomERC721.deploy('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', ethers.constants.AddressZero, ethers.constants.AddressZero);
  ...
  const nukeFund = await NukeFund.deploy(customERC721.address, "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266");
  ...
  const entropyGenerator = await EntropyGenerator.deploy(customERC721.address, '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266');
  ...
  await customERC721.setEntropyGenerator(entropyGenerator.address);
  ...
  const daoFund = await DAOFund.deploy('0x4826533B4897376654Bb4d4AD88B7faFD0C98528');
  ...
  const entityMerging = await EntityMerging.deploy(customERC721.address, nukeFund.address, entropyGenerator.address);
  ...
  // Initialize EntropyGenerator with CustomERC721 address
  await entropyGenerator.setAllowedCaller(customERC721.address);
  console.log("EntropyGenerator initialized with CustomERC721.");
}
