...
contract NukeFund is ReentrancyGuard, CustomOwnable {
    ...
    constructor(address _mintContractAddress) CustomOwnable(msg.sender){
    ...
    function nuke(uint256 tokenId) public nonReentrant stopInEmergency {
    ...
    function withdraw(uint256 amount) public onlyOwner nonReentrant stopInEmergency {
