async function main() {
    ...
    const customERC721 = await CustomERC721.attach("0x5FbDB2315678afecb367f032d93F642f64180aa3");
    ...
    console.log(`Mint Count for Generation ${currentGeneration}:`, mintCount.toString());
  }
