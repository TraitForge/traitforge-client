...
export const PossibleEntityCard = ({
  ...
  const wrapperClasses = classNames(
    'overflow-hidden border-[1.33px] border-orange rounded-[20px] px-2 md:px-4 py-1 md:py-5 bg-gradient-to-bl to-light-dark w-full',
    {
  ...
  const badgeClasses = classNames(
    'text-[16px] lg:text-base 3xl:text-[20px] py-2 px-[14px] bg-opacity-20 rounded-xl'
  );

  return (
    <div className={wrapperClasses}>
      <div className="flex justify-between items-center mb-2">
        <h6 className={badgeClasses}>GEN{generation}</h6>
        <h6 className={badgeClasses}>{role}</h6>
      </div>
      <Image
        loading="lazy"
        ...
        height={250}
      />
      <div className="mt-5 text-base xl:text-[24px] flex max-md:flex-wrap gap-y-2 text-left gap-x-3">
