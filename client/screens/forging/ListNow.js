...
export const ListNow = ({ selectedForListing, listEntityForForging, handleStep }) => {
      ...
      <div className="container w-screen pt-5 flex flex-col h-full">
        ...
        <div className=" md:bg-dark-81 md:w-[60%] xl:w-1/2 mx-auto pt-10 pb-[50px] md:px-[70px] lg:px-[100px] flex flex-col rounded-[20px] items-center">
          <div className="max-md:order-2 w-full">
            <h3 className="text-large font-electrolize mb-2">Set a fee for your forger:</h3>
            <p className="text-sm mb-2 uppercase text-neutral-100">min fee is 0.01 ETH</p>
            <input
              ...
              min={0.01}
            />
            {showFeeError && <p className="text-left text-sm py-1 text-red-600">Please add fee in eth</p>}
          </div>
