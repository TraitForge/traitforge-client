      ...
      try {
        ...
        const entitiesPromises = data.map(async entity => {
          const [nukeFactor, breedPotential, performanceFactor, isSire] =
            await entropyContract.deriveTokenParameters(entity);
    ...
    <div className="Trading-page">
      <div className="market-page-container">
        <div className="Trading-top-buttons">
          <button className="sellEntity" onClick={() => setModalOpen(true)}>
            Sell Your Entity
          </button>
          ...
          <div className="tradingfilters">
            ...
            <button
              className={filter === 'Forger' ? 'active-filter' : ''}
              onClick={() => handleFilterChange('Forger')}
            >
              Forgers
            </button>
            <button
              className={filter === 'Merger' ? 'active-filter' : ''}
